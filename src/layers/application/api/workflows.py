"""
Workflows API endpoints for the Digital Twin Platform.

This module provides REST API endpoints for managing cross-layer workflows,
including creation, execution, monitoring, and complex orchestration scenarios.

LOCATION: src/layers/application/api/workflows.py
"""
...
class WorkflowCreate(BaseModel):
    ...
    class Config:
        schema_extra = {
            "example": {
                "workflow_name": "Smart Factory Analysis Pipeline",
                "description": "Complete analysis pipeline for smart factory operations",
                "workflow_type": "sequential",
                "context_digital_twin_id": "123e4567-e89b-12d3-a456-426614174000",
                "steps": [
                    {
                        "step_name": "collect_sensor_data",
                        "step_type": "replica",
                        "entity_id": "replica-123",
                        "operation": "aggregate_data",
                        "input_data": {"force_aggregation": True}
                    },
                    {
                        ...
                        "operation": "execute",
                        "input_data": {"analysis_type": "anomaly_detection"},
                ...
                "workflow_config": {
                    ...
                    "notification_webhook": "https://api.company.com/notifications"
                }
            }
        }
...
class WorkflowExecution(BaseModel):
    ...
    class Config:
        schema_extra = {
            "example": {
                "input_data": {
                    "factory_section": "production_line_1",
                ...
                "callback_url": "https://api.company.com/workflow-completed"
            }
        }


class WorkflowTemplate(BaseModel):
    """Model for creating workflow templates."""
    ...
    class Config:
        schema_extra = {
            "example": {
                "template_name": "IoT Analytics Pipeline",
                "template_description": "Standard pipeline for IoT data analytics",
                "category": "analytics",
                "workflow_definition": {
                ...
                "parameters": {
                    "data_source": "{{replica_id}}",
                    "analysis_service": "{{service_id}}",
...
async def list_workflows(
    ...
    digital_twin_id: Optional[UUID] = Query(None, description="Filter by Digital Twin context"),
    limit: int = Query(100, ge=1, le=1000, description="Maximum number of results"),
    offset: int = Query(0, ge=0, description="Number of results to skip")
) -> Dict[str, Any]:
    """List workflows with optional filtering."""
    try:
        # Mock workflow list - would be real from digital twin layer
        workflows = [
            {
                "workflow_id": "wf-analytics-001",
                "workflow_name": "Production Analytics Pipeline",
                "workflow_type": "sequential",
                "status": "active",
                "step_count": 4,
                "context_digital_twin_id": "dt-factory-001",
                "created_at": "2024-01-01T08:00:00Z",
                "last_execution": "2024-01-01T10:25:00Z",
                "execution_count": 47
            },
            {
                "workflow_id": "wf-maintenance-002", 
                "workflow_name": "Predictive Maintenance Flow",
                "workflow_type": "conditional",
                "status": "active",
                "step_count": 6,
                "context_digital_twin_id": "dt-equipment-001",
...
async def create_workflow(
    ...
    try:
        # Note: This would call the digital twin layer for cross-layer workflow creation
        ...
        return {
            ...
            "context_digital_twin_id": workflow_data.context_digital_twin_id,
...
async def get_workflow(
    ...
    try:
        # Mock workflow details - would be real from digital twin layer
        return {
            "workflow_id": workflow_id,
            "workflow_name": "Production Analytics Pipeline",
            "description": "Analyzes production data and generates insights",
            "workflow_type": "sequential",
            "status": "active",
            "step_count": 4,
            "context_digital_twin_id": "dt-factory-001",
            "created_at": "2024-01-01T08:00:00Z",
            "last_modified": "2024-01-01T08:30:00Z",
            "execution_stats": {
                "total_executions": 47,
                "successful_executions": 44,
                "failed_executions": 3,
                "average_duration_seconds": 156.7
            },
            "steps": [
                {
                    "step_name": "collect_data",
                    "step_type": "replica",
                    "entity_id": "replica-sensors-001",
                    "operation": "aggregate_data",
                    "status": "active"
                },
                {
                    "step_name": "analyze_data", 
                    "step_type": "service",
                    "entity_id": "service-analytics-001",
                    "operation": "execute",
                    "status": "active"
                }
            ]
...
async def delete_workflow(
    workflow_id: str = Path(..., description="Workflow ID"),
    force: bool = Query(False, description="Force deletion even if executions are running"),
    gateway: APIGateway = Depends(get_gateway)
) -> Dict[str, str]:
    """Delete a workflow."""
    try:
        return {
            "message": f"Workflow {workflow_id} deletion requested",
            "workflow_id": workflow_id,
            "force": force,
            "status": "accepted"
        }
...
async def execute_workflow(
    workflow_id: str = Path(..., description="Workflow ID"),
    execution_data: WorkflowExecution = Body(...),
    gateway: APIGateway = Depends(get_gateway)
) -> Dict[str, Any]:
    """Execute a workflow."""
    try:
        ...
        # Note: This would call the gateway to execute cross-layer workflow
        result = {
            "workflow_id": workflow_id,
            "execution_id": execution_id,
            "status": "running" if execution_data.async_execution else "completed",
            "started_at": datetime.utcnow().isoformat(),
            "priority": execution_data.priority,
            "async_execution": execution_data.async_execution
        }
        
        if not execution_data.async_execution:
            # Simulate synchronous execution result
            result.update({
    ...
    try:
        ...
        executions = [
            {
                ...
                "completed_at": "2024-01-01T10:27:36Z",
            ...
            {
                "execution_id": f"exec-{workflow_id}-002",
                "status": "running",
        ...
        return {
            ...
            "pagination": {
                ...
                "limit": limit,
                "offset": offset,
                "count": len(paginated_executions)
            }
        }
            ...
            "step_results": [
                {
                    ...
                    "status": "completed",
                    "started_at": "2024-01-01T10:25:00Z",
                    "completed_at": "2024-01-01T10:25:45Z",
                    "duration_seconds": 45.2,
                    "output_data": {"data_points": 8947, "quality_score": 0.94}
                },
                {
                    "step_name": "analyze_data",
                    "status": "completed", 
                    "started_at": "2024-01-01T10:25:45Z",
                    "completed_at": "2024-01-01T10:27:36Z",
                    "duration_seconds": 111.2,
                    "output_data": {"insights": 12, "anomalies": 2, "confidence": 0.89}
                }
            ],
            "final_result": {
                "success": True,
                "summary": {
                    ...
                    "quality_score": 0.94,
                    "recommendations": [
                        "Increase monitoring on sensor-003",
                        "Schedule maintenance for equipment-007"
                    ]
                }
            }
        }
...
async def list_workflow_templates(
    ...
    try:
        templates = [
            {
                "template_id": "iot-analytics-pipeline",
                "template_name": "IoT Analytics Pipeline",
                "description": "Standard pipeline for IoT sensor data analysis",
                "category": "analytics",
                "step_count": 3,
            ...
            {
                "template_id": "predictive-maintenance",
                "template_name": "Predictive Maintenance Flow",
                "description": "Comprehensive predictive maintenance workflow",
            ...
            {
                "template_id": "quality-control",
                "template_name": "Quality Control Assessment",
                "description": "Automated quality control and reporting",
                "category": "quality",
                "step_count": 4,
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Failed to list workflow templates: {e}"
        )
...
async def create_from_template(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Failed to create workflow from template: {e}"
        )
...
async def get_workflow_metrics(
    workflow_id: str = Path(..., description="Workflow ID"),
    time_range: int = Query(86400, ge=3600, description="Time range in seconds"),
    gateway: APIGateway = Depends(get_gateway)
) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "execution_metrics": {
                ...
                "failed_executions": 9,
                "success_rate": 0.942,
                "average_duration_seconds": 167.8,
                "min_duration_seconds": 89.2,
                "max_duration_seconds": 423.7,
                "executions_per_hour": 6.5
            },
            "step_performance": {
                "collect_data": {
                    "average_duration": 45.6,
                    "success_rate": 0.987,
                    "error_types": {"timeout": 2, "connection_error": 0}
                },
                "analyze_data": {
                    "average_duration": 122.2,
                    "success_rate": 0.954,
                    "error_types": {"insufficient_data": 5, "processing_error": 2}
                }
            },
            "resource_utilization": {
                "average_memory_mb": 445,
                "peak_memory_mb": 768,
                "average_cpu_percent": 23.7,
                "network_io_mb": 156.4
            },
            "error_analysis": {
                "most_common_errors": [
                    {"error": "insufficient_data", "count": 5, "percentage": 55.6},
                    {"error": "processing_timeout", "count": 2, "percentage": 22.2},
                    {"error": "connection_error", "count": 2, "percentage": 22.2}
                ]
            },
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Failed to get workflow metrics: {e}"
        )


@router.get("/analytics/global", summary="Get Global Workflow Analytics")
async def get_global_workflow_analytics(
    time_range: int = Query(86400, ge=3600, description="Time range in seconds"),
    gateway: APIGateway = Depends(get_gateway)
) -> Dict[str, Any]:
    ...
    try:
        return {
            ...
            "platform_metrics": {
                ...
                "active_executions": 7,
                "overall_success_rate": 0.934
            },
            "workflow_types": {
                "sequential": {"count": 12, "success_rate": 0.945},
                "parallel": {"count": 6, "success_rate": 0.928},
                "conditional": {"count": 4, "success_rate": 0.912},
                "dag": {"count": 1, "success_rate": 0.876}
            },
            "performance_trends": {
                "average_execution_time_trend": "decreasing",
                "success_rate_trend": "stable",
                "throughput_trend": "increasing"
            },
            "resource_efficiency": {
                "workflows_per_cpu_hour": 47.3,
                "average_memory_efficiency": 0.67,
                "cost_per_execution": 0.023
            },
            "top_performing_workflows": [
                {"workflow_id": "wf-analytics-001", "success_rate": 0.989, "avg_duration": 134.5},
                {"workflow_id": "wf-maintenance-002", "success_rate": 0.976, "avg_duration": 298.7}
            ],
            "generated_at": datetime.utcnow().isoformat()
        }
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Failed to get global workflow analytics: {e}"
        )
...
async def bulk_execute_workflows(
    workflow_executions: List[Dict[str, Any]] = Body(..., description="List of workflow executions"),
    gateway: APIGateway = Depends(get_gateway)
) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "failed": len(workflow_executions) - successful,
            "results": results,
            "batch_execution_id": f"batch-{int(datetime.utcnow().timestamp())}",
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Bulk workflow execution failed: {e}"
        )