...
class StandardDigitalTwin(IDigitalTwin):
    ...
    def __init__(self, twin_id: UUID, configuration: DigitalTwinConfiguration, metadata: BaseMetadata, models: Optional[List[TwinModel]]=None):
        self._id = twin_id
...
class DigitalTwinFactory(IDigitalTwinFactory):
    ...
    async def create_twin(self, twin_type: DigitalTwinType, config: DigitalTwinConfiguration, models: Optional[List[TwinModel]]=None, metadata: Optional[BaseMetadata]=None) -> IDigitalTwin:
        try:
            ...
            twin = StandardDigitalTwin(twin_id=metadata.id, configuration=config, metadata=metadata, models=models)
